...
public class C09_NestedLoop {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <=kisaKenar ; i++) {
            ...
            // Bu nesteed yapisini carpim talosu gibi kare ve dikörtgen tablolarda kullanabiliriz
            // ayni zamanda ücgen tablolarda da kullanabiliyoruz bir sonraki ornekte yapacagiz
        }
    }
}
