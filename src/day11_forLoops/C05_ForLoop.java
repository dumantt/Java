...
public class C05_ForLoop {
    public static void main(String[] args) {
        ...
        if (bitis<baslangic){
            ...
            int toplam=0;
            for (int i = baslangic; i <=bitis ; i++) { //ilk sayi zaten dahil son sayiyi da <= yaparak dahil etmis olduk
                toplam += i; //tum sayilari sirasi ile toplam'a ekledik >>klas hareket bu şekilde iyi anladim bu methodu
            }
