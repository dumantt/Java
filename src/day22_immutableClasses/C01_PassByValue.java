...
public class C01_PassByValue {
    public static void main(String[] args) {
        ...
        /*
            ...
            Eger method'da elementlere set ile atama yapilirsa, main method'daki elementler de degismis olur
            Eger list veya array'e yeni bir list veya array degeri add ile atanirsa bu atama method'da kalir,
    ...
    public static void yeniListAta(List<Integer> sayilar){
        sayilar= new ArrayList<>(); // ArrayList<>() deyince önceki değerler kaybolmuş oluyor.
        sayilar.add(34);
        sayilar.add(98);
        sayilar.add(11);
