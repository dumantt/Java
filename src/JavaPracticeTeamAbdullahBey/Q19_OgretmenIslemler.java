...
public class Q19_OgretmenIslemler implements Q19_IIslemler {
    Scanner scan = new Scanner(System.in);
    static int sicilNo = 1000;

    ArrayList<Q19_Ogretmen> ogretmenList = new ArrayList<>();
    ...
    public void ekleme() {
        ...
        Q19_Ogretmen ogretmen = new Q19_Ogretmen (ad, sAd, tcNo, yas, bolum, sicilNo++);
    ...
    public void arama() {
        ...
        String tcNo = scan.next();
        int kontrol = 0;
        for (Q19_Ogretmen each : ogretmenList) {
