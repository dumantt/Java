...
3. ARAMA VE SİLME İŞLEMLERİ KİMLİK NO YA GÖRE YAPILMALIDIR.
    ...
    ArrayList<Q17_Ogrenci> ogrList = new ArrayList<>();
	...
	-SINIF
        ...
        Q17_Ogrenci ogrenci = new Q17_Ogrenci(ad, sAd, tcNo, yas, ++numara, sinif);
        ogrList.add(ogrenci);
        listeleme();
        islemler();
