...
public class C07_substring {
    public static void main(String[] args) {
        ...
        System.out.println(str.toUpperCase().substring(12,15)); // bunu ben yaptım büyük yazdırma
        ...
        System.out.println(str.substring(9, 10).toUpperCase()); // N bu hala string önemli
        System.out.println(str.toUpperCase().charAt(9)); // N bu char oldu artık
        ...
        System.out.println(str.substring(str.length())); // hiclik yazdirir space degil
        ...
        System.out.println("=======");
        System.out.println(str.substring(str.length()-1)); // sondan bir oncekini yazdırma bunu ben yaptim
