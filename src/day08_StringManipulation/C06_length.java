...
public class C06_length {
    public static void main(String[] args) {
        ...
        System.out.println(str.length()); // 50 stringin uzunlugunu bulmak icin yaptık. dinamik kod yani
        ...
        System.out.println(str.charAt(index)); // herseferinde random birini seçer verdigimiz içerikten
