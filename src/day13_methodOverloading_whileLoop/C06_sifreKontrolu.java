...
public class C06_sifreKontrolu {
    public static void main(String[] args) {
        ...
        // 10. gün 6. class Soru 4 : Kullanicidan bir sifre isteyip, asagidaki sartlari kontrol edin
        ...
        // sifre kontrolunu bir method da yazip true/false dondurun
    ...
    public static boolean sifreKontrolEt(String sifre) {
        ...
        if (!(sifre.charAt(0) >= 'a' && sifre.charAt(0) <= 'z')) {
            ...
            System.out.println("Ilk harf kucuk harf olmali"); // >>> anladigim kadariyla bu line daki kod calisirsa
            flag++; // bir ceza puani aldi                    // >>> bu line daki kod da calisiyor ve artiriyor
        }                                                     //>>> degilse calismiyor ve artirmiyor
        // - son karakter rakam olmali
