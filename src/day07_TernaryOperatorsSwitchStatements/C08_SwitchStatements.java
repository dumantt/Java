...
public class C08_SwitchStatements {
    public static void main(String[] args) {
        ...
        if (islem=='+'){
            ...
            System.out.println("Sayilarin carpimi :" + sayi1*sayi2); // işlem önceliğinden ötürü parantez koymasakta olur
        } else if (islem=='/') {
            System.out.println("Sayilarin bolumu : " + sayi1/sayi2); // işlem önceliğinden ötürü parantez koymasakta olur
        }else {
