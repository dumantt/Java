...
public class C01_NullPointer {
    public static void main(String[] args) {
        ...
        System.out.println(str2.isEmpty()); // false >>>>>>>>> spaceyi boşlugu hiçlik kabul etmiyor, içinde bir şey yok diyor
        System.out.println(str1.isBlank()); // true
        System.out.println(str2.isBlank()); // true >>>>>>>>>>> spaceyi boşlugu hiçlik kabul ediyor, içinde bir şey var diyor
        ...
        System.out.println(str4.concat("Ali Can")); // NullPointerException >>>> concat ile "+" nın farkı ortaya çikiyor
        // fark su concat bir islem yapiyor "+" ise sadace birlestirici gibi sanki yazi yazarken bosşul koymussun gibi.
        // anladigim kadariyla.
