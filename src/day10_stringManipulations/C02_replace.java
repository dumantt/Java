...
public class C02_replace {
    public static void main(String[] args) {
        ...
        int results = sonuc.indexOf("results");
        String sonucSayisi = sonuc.substring(over+5,results-1);

        //System.out.println(sonucSayisiStr);                 >>> bu iki satırı kodumuzu kontrol edelim diye yaziyoruz
        //System.out.println(sonucSayisiStr.replace(",","")); >>> sonrasında silebiliriz

        String sonucSayisiStr= sonucSayisi.replace(",","");
        int sonucsayisiInt = Integer.parseInt(sonucSayisiStr);

        //int sonucsayisiInt = Integer.valueOf(sonucSayisiStr); >>>>>> valueOf da calisiyor

        if (sonucsayisiInt>10000) System.out.println("arama sonuc testi PASSED");
