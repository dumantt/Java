...
public class C03_startsWith {
    public static void main(String[] args) {
        ...
        System.out.println(str.startsWith("")); // true >>>>>hiçlikle basladigi icin true
        System.out.println(str.contains("mutlu")); // true
        System.out.println(str.startsWith("mutlu")); // false
        System.out.println(str.startsWith("mutlu",5)); // true >>>>> 5. index ve sonrsai mutlu ile başlıyor stringprefix,int toffset olan bu
