...
public class C05_indexOf {
    public static void main(String[] args) {
        ...
        System.out.println(str.indexOf('a')); // 1 >>>>>metindeki ilk a nın indexini bulur java akisi geregi
        System.out.println(str.indexOf("v")); // 2
        System.out.println(str.indexOf("cok")); // 17 >>>>>> bu 17 ilk harfin indexi yani kelimenin ilk harfinin
        System.out.println(str.indexOf("a", 5)); // 13 >>>> burada beşden sonraki ilk a nın indexini bulduk
