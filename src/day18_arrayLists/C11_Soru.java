...
public class C11_Soru {
    ...
    public static List<String> istenmeyenIsimleriSil(List<String> isimler){
        ...
        String istenmeyenHarf=scan.next().substring(0,1); // contains diyecegimimz için string olarak aldık

        List<String> yeniListe=new ArrayList<>();
        // yeni bir liste oluşturduk çünkü mevcut listeden istenmeyen harflerin bulundugu elemanlari silseydik
        // indexler kayacakti ve saglikli bir sonuç alamayacaktik bu sebeple yeni listeye atama yaparak çözüyoruz.
