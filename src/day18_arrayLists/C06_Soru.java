...
public class C06_Soru {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < arr.length ; i++) {
            ...
            // benzersizelementler, arr daki int i içermiyorsa, int i benzersizelementlere ekle denklemi yazmış olduk.
            // benzersiz elementler başlangıçta boş biz zaten onun için oluşturduk 13. satırda
        }
        ...
        for (int i = 0; i < arr.length ; i++) {
            arr[i] = benzersizElementlerList.get(i); //.get kulandik
        }
