...
public class day04_Q1_ArraylerinOrtakElemanlariniBulma {
...
//      * Input1 : {John,Brad,Angel,Sofia,Emily} Input2 : {sofia,brad,grace,emily,hazel}
    ...
    private static void ortakElemanlar(String[] arr1, String[] arr2) {
        ...
        ArrayList<String> arrList = new ArrayList<>(); // bod kutu işlevi görüyor basta uzunluk vermemiz gerekkmiyor

        for (int i = 0; i < arr1.length; i++) {

            for (int j = 0; j < arr2.length; j++) {

                if (arr1[i].equalsIgnoreCase(arr2[j])) { // eşiteşittir Stringlerde her zaman saglıklı sonuc vermiyor
                                                         // onun icin equals kullandik
                    arrList.add(arr1[i]);
                }
            }
        }
